import pytest
from src.brain.strategies.range import RangeBrain
from src.brain.game_state import GameState, Player
from src.brain.action_plan import ActionType
from src.brain.player_analysis import StatsAwareRangeModel, ShowdownAwareRangeModel
...
class TestRangeBrainOpponentModeling:
    ...
    def _build_state_with_opponent(self, vpip: float, pfr: float,
        ...
        from src.brain.player_analysis import PlayerManager
    ...
    def test_nit_opponent_raises_call_threshold(self):
        ...
        decision_nit = brain_nit.make_decision(state_nit)
        decision_maniac = brain_maniac.make_decision(state_maniac)
